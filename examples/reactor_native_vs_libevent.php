...
/**
 * examples/reactor_native_vs_libevent.php
 * 
...
$reactor->schedule(function() use ($reactor) { $reactor->stop(); }, $delay = RUN_TIME);
...
NativeReactor:   $nativeCount
LibeventReactor: $libeventCount
