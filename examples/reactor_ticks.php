 ...
 * allows integration of Amp-based tools with other event systems and avoids the need to explicitly
...
$reactor->onReadable(STDIN, function($stdin, $trigger) use (&$reactorHasControl) {
